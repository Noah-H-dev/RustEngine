...
impl Unit {
    ...
    // TODO switch decide() from "alongside" to "drives movement": return a MOVE
    // toward the next patrol step and route movement through apply_action, reworking
    // update accordingly. Currently a stub returning NONE (see notes.txt).
